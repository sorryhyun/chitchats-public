...
Usage:
    ...
    python load_test_network.py --password "your_password" --users 20 --rooms 3 --duration 120 --base-url http://localhost:8001
"""
...
def main():
    ...
    parser.add_argument(
        "--base-url", default="http://localhost:8001", help="Base URL of the API (default: http://localhost:8001)"
    )
