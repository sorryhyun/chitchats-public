        ...
        <div className="bg-slate-50 rounded-lg p-4">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <span className="font-medium text-slate-700">
                {t('ctrlEnterToSend', 'Ctrl+Enter to Send')}
              </span>
            </div>
            <Toggle checked={ctrlEnterToSend} onCheckedChange={setCtrlEnterToSend} />
          </div>

          <StatusIndicator
            status={ctrlEnterToSend ? 'available' : 'disabled'}
            text={
              ctrlEnterToSend
                ? t('ctrlEnterEnabled', 'Ctrl+Enter sends message')
                : t('ctrlEnterDisabled', 'Enter sends message')
            }
          />
          ...
          <p className="mt-3 text-xs text-slate-500">
            {t(
              'ctrlEnterHelpText',
              'When enabled, Ctrl+Enter sends the message and Enter creates a new line. When disabled, Enter sends and Shift+Enter creates a new line.'
            )}
          </p>
        </div>
      </ModalContent>
